...
ALLOWED_HOSTS = ['127.0.0.1','greenmyday.com','www.greenmyday.com']


INTERNAL_IPS = ('217.115.117.19',)

SITE_URL = "http://greenmyday.com"
HOSTNAME = 'http://greenmyday.com'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'footprints',                      # Or path to database file if using sqlite3.
...
#WSGI_APPLICATION = 'tcaccount.wsgi.application'
